...
// Generate a Playwright test for bookstore checkout
        ...
        public void runBookstoreTest() {
                try (Playwright playwright = Playwright.create()) {
                        ...
                        assertThat(page.getByRole(AriaRole.LINK,
                                        new Page.GetByRoleOptions().setName(Pattern.compile("Cart\\s*1\\s*items?",
                        ...
                        assertThat(
                                        page.getByRole(AriaRole.HEADING,
                                                        new Page.GetByRoleOptions()
                                                                        .setName("Your Shopping Cart(1 Item)"))
                                                        .first())
                                        .isVisible();
                        ...
                        assertThat(page.getByRole(AriaRole.TEXTBOX,
                                        new Page.GetByRoleOptions().setName(Pattern.compile("Quantity, edit and press",
                                                        Pattern.CASE_INSENSITIVE))))
                                        .isVisible();
                        ...
                        assertThat(sidebar.getByText("$164.98", new Locator.GetByTextOptions().setExact(true)))
                                        .isVisible();
                        assertThat(sidebar.getByText("$3.00", new Locator.GetByTextOptions().setExact(true)))
                                        .isVisible();
                        assertThat(sidebar.getByText("TBD", new Locator.GetByTextOptions().setExact(true))).isVisible();
                        assertThat(sidebar.getByText("$167.98", new Locator.GetByTextOptions().setExact(true)))
                                        .isVisible();
                        ...
                        page.getByRole(AriaRole.TEXTBOX,
                                        new Page.GetByRoleOptions().setName("Email address (required)"))
                                        .fill("nicoinsist@gmail.com");
                        page.getByRole(AriaRole.TEXTBOX,
                                        new Page.GetByRoleOptions().setName("Email address (required)")).press("Tab");
                        page.getByRole(AriaRole.COMBOBOX, new Page.GetByRoleOptions().setName("United States: +"))
                                        .press("Tab");
                        ...
                        Locator subtotal = checkoutSidebar
                                        .locator(".bned-checkout-total-wp:has-text('Order Subtotal') .value");
                        ...
                        Locator productLink = page.locator(
                                        ".bned-order-summary-container .bned-order-summary-entry-name a:visible")
                        ...
                        assertThat(subtotalVisible.filter(new Locator.FilterOptions().setHasText("$164.98")).first())
                                        .isVisible();
                        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Continue")).click();

                        assertThat(page.getByRole(AriaRole.HEADING,
                                        new Page.GetByRoleOptions().setName("Payment Information"))).isVisible();
                        Locator paymentSidebar = page
                                        .locator(".bned-payment-order-summary, .bned-order-summary-container:visible")
                                        .first();
                        assertThat(paymentSidebar.locator(".bned-order-summary-entry-total:has-text('$164.98')"))
                                        .isVisible();
                        ...
                        assertThat(page.locator("body")).containsText(
                                        Pattern.compile("(cart\\s*(is\\s*)?empty|no items)", Pattern.CASE_INSENSITIVE));
                        page.close();
                }
        }
}
